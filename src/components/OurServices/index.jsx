...
function ServiceCard({ size }) {
  ...
  return (
    <div
      className={
        'font-merriweather min-w-[21.875rem] basis-[450px] bg-[url(@/assets/350x350.png)] bg-cover bg-center bg-no-repeat max-[969px]:flex-grow' +
        (size === 'big' ? ' min-[969px]:flex-grow' : ' min-[969px]:flex-shrink')
      }
    >
      <div className='relative flex h-full flex-col justify-end overflow-hidden bg-neutral-800/50 px-[70px] py-[55px] text-white'>
        ...
        {open && (
          <div
            className={
              'absolute left-0 top-0 flex h-full w-full flex-col bg-emerald-300 px-[70px] py-[55px] text-black'
            }
          >
            <h3 className='pb-5 font-bold uppercase'>Lorem ipsum dolor sit amet</h3>
